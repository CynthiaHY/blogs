...
- lang: zh-Hans
  path: /zh-Hans/2023/07/24/23.0.0.3.html
---
...
我们很高兴地宣布 Open Liberty 23.0.0.3发布了，这是自 5 年前首次亮相以来最大的运行时版本之一！ 此版本包括 Jakarta EE 10 Platform、Web Profile，并且首次包含Core Profile。还在构成profiles的大部分功能中添加了许多新的增强功能。
